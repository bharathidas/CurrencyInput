...
export class CurrencyInput extends Component<CurrencyInputContainerProps> {
    ...
    render(): ReactNode {
        ...
        const placeholder = this.props.placeholderKey?.value;
        ...
        const prefix = this.props.prefixKey?.value;
        const suffix = this.props.suffixKey?.value;
        const decimalSeparator = this.props.decimalSeparatorKey?.value;
        const groupSeparator = this.props.groupSeparatorKey?.value;
